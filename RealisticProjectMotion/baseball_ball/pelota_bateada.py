...
#-----------------绘图------------------ 
plt.title("Efecto del viento en una pelota de beisbol")
plt.xlabel("Desplazamiento x (m)")
plt.ylabel("Desplazamiento y (m)")   
plt.plot(trajectory[0][0],trajectory[0][1],"g--",label="Sin viento", color="blue")
plt.plot(trajectory[1][0],trajectory[1][1],"k-",label="Viendo de popa", color="brown")
plt.plot(trajectory[2][0],trajectory[2][1],"k-",label="Viento de proa", color="cyan")
plt.legend()
plt.ylim(0,30)
plt.grid()
plt.show()   